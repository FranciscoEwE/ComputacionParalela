...
main(){
    ...
    cout <<"|     double      |Single Precision Floating pointr|     "    <<sizeof(double)<<"             |    "<<SIZEBITES(double)<<"          |       "<<(endl);
    cout <<"|     long double |Single Precision Floating point |     "    <<sizeof(long double)<<"            |    "<<SIZEBITES(long double)<<"         |       "<<(endl);
