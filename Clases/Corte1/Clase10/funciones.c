...
/** funcion reserva de memoria**/
double ** ReservaMeM (int size){
	// reservamos la memoria de dimension N*N
	double * valor= (double *) malloc(size*size*sizeof(double));
	//REseerva de un vector de 'punteros double' con dimension size
	double ** ptr = (double **) malloc(size*size*sizeof(double*));
	
	//iteracion para cada puntero se ubique en la memoria reservada
...
//IMPRIMIR LAS MATRICES DOBLE PUNTERO
